...
class dynamic_map {
 ...
 public:
  ...
  template <typename InputIt,
            typename Hash     = cuco::default_hash_function<key_type>,
            typename KeyEqual = cuda::std::equal_to<key_type>>
  void insert_unsafe(InputIt first,
                     InputIt last,
                     Hash hash           = Hash{},
                     KeyEqual key_equal  = KeyEqual{},
                     cudaStream_t stream = nullptr);
  ...
  template <typename KeyIt,
            ...
            typename Hash     = cuco::default_hash_function<key_type>,
            typename KeyEqual = cuda::std::equal_to<key_type>>
  void insert_key_value_unsafe(KeyIt key_first,
                               KeyIt key_last,
                               ValueIt value_first,
                               cudaStream_t stream = nullptr,
                               Hash hash           = Hash{},
  ...
  template <typename InputIt,
            ...
            typename Hash     = cuco::default_hash_function<key_type>,
            typename KeyEqual = cuda::std::equal_to<key_type>>
  void find_value_and_mask(InputIt first,
                           InputIt last,
  ...
  std::pair<KeyOut, ValueOut> retrieve_all_naive(KeyOut keys_out,
                                                 ValueOut values_out,
   ...
   */
  template <typename KeyOut, typename ValueOut>
  int64_t retrieve_all(KeyOut keys_out,
                       ValueOut values_out,
                       cudaStream_t stream = 0) const;
